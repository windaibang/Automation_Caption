...
- Name: ui\Footer.spec.ts >> TC12-Đăng kí tư vấn với tên rất dài
...
Locator: getByText('Đăng kí không thành công')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('Đăng kí không thành công')
...
- textbox "Họ và tên": Nguyen Van A Nguyen Van B Nguyen Van C Nguyen Van D Nguyen Van E Nguyen Van F
