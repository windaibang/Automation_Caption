...
- Name: ui\Footer.spec.ts >> TC02-Đăng kí tư vấn khi trường email rỗng
...
Locator: getByText('Email không được để trống')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('Email không được để trống')
