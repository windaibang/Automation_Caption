...
- Name: ui\Footer.spec.ts >> TC25-Đăng kí tư vấn với email và tên dưới 8 ký tự
...
Locator: getByText('Tên quá ít kí tự')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('Tên quá ít kí tự')
...
- textbox "Họ và tên": Nam
- textbox "Email": a@b.io
