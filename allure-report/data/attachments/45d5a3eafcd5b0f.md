...
- Name: ui\Footer.spec.ts >> TC04-Đăng kí tư vấn khi trường số điện thoại rỗng
...
Locator: getByText('Số điện thoại không được để')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('Số điện thoại không được để')
