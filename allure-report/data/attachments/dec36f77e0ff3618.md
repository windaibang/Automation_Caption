...
- Name: ui\Footer.spec.ts >> TC06-Đăng kí tư vấn với email không hợp lệ (không có @)
...
Locator: getByText('Email sai định dạng')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('Email sai định dạng')
...
- textbox "Email": invalidemail.com
